        ...
        <div className="min-h-screen bg-background overflow-x-hidden flex flex-col">
            ...
            <main className="flex-grow pt-20">
                ...
                <section className="relative min-h-[716px] flex items-center overflow-hidden">
                    ...
                    <p className="font-headline-lg text-[32px] leading-tight text-primary opacity-95 md:text-[42px]">
                        Tinh hoa thảo dược, chăm sóc sức khỏe từ thiên nhiên
                    </p>
                            <div className="mt-lg flex gap-md">
                                <div className="w-12 h-[2px] bg-soft-sage self-center"></div>
                        <p className="font-body-lg max-w-xl text-[20px] font-medium leading-relaxed text-on-background italic md:text-[24px]">
