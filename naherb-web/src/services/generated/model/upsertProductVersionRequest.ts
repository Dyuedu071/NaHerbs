 ...
 */
import type { UpsertProductVersionRequestStatus } from './upsertProductVersionRequestStatus';

export interface UpsertProductVersionRequest {
  name: string;
  displayOrder?: number;
  status?: UpsertProductVersionRequestStatus;
}
